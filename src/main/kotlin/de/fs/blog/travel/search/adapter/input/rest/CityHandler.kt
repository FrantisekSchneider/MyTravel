package de.fs.blog.travel.search.adapter.input.rest

import de.fs.blog.travel.search.adapter.input.rest.data.CityJson
...
internal class CityHandler(private val findCitiesUseCase: FindCitiesUseCase) {
